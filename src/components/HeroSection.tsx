  ...
  return (
    <section className="relative overflow-hidden py-24 px-4 md:py-32">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        {/* バッジ */}
        <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-village-pink-200 px-4 py-1.5 rounded-full text-xs font-medium text-village-pink-600 mb-6 shadow-sm animate-fade-in-up">
        ...
        {/* タイトル */}
        <h1 className="text-5xl md:text-7xl font-bold mb-5 leading-tight animate-fade-in-up">
          <span className="gradient-text-animated">ポイ活の村</span>
        </h1>

        {/* サブタイトル */}
        <p className="text-lg md:text-xl text-gray-500 mb-2 font-medium animate-fade-in-up">
          初心者でも安心のポイ活コミュニティ
        </p>
        <p className="text-sm text-gray-400 mb-10 animate-fade-in-up">
